...
@section('styles')
    ...
    <style>
        .govt-container { max-width: 1000px; margin: 0 auto; }
        ...
        .badge-pg { background: #fef3c7; color: #b45309; padding: 2px 10px; border-radius: 9999px; font-size: 0.75rem; font-weight: 600; }
    </style>
@endsection
...
<div class="govt-container">
    <div class="govt-header-container">
        <div class="header-content">
            ...
            <p>Manage Pag-IBIG (HDMF) contribution brackets</p>
        </div>
